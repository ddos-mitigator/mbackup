...
* Обновление файла от прошлой версии (v20.06) до текущей (v20.08.6);

## Аргументы

Версия скрипта `v3.2008.2` имеет один обязательный и семь необязательных (ситуационных) аргумента.
